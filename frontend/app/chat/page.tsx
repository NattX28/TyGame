...
const ChatList = () => {
  return (
    <>
      ...
      <MsgYou msg={"Hi thereaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa!"} person={{ name: "Jane Doe", avatar: "/media/images/first.jpg" }} />
    </>
  )
}
